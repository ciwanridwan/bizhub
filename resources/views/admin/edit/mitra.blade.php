...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{ route('update-mitra') }}" autocomplete="off" class="form-horizontal">
                    @csrf
                    @method('post')

                    <div class="card ">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title">{{ __('Edit Mitra') }}</h4>
                        </div>
                        <div class="card-body ">
                            @if (session('status'))
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('nama') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}"
                                            ...
                                            placeholder="" value="{{$mitra->nama}}" required="true"
                                            aria-required="true" />
                                        @if ($errors->has('nama'))
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"
                                            ...
                                            placeholder="" value=" {{$mitra->email}} " required="true"
                                            aria-required="true" />
                                        @if ($errors->has('email'))
                                        <span id="name-error" class="error text-danger"
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('nomor_telepon') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('nomor_telepon') ? ' is-invalid' : '' }}"
                                            ...
                                            placeholder="" value="{{$mitra->nomor_telepon}}" required="true"
                                            aria-required="true" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('badan_usaha') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('badan_usaha') ? ' is-invalid' : '' }}"
                                            name="badan_usaha" id="input-name" type="text"
                                            placeholder="" value=" {{$mitra->badan_usaha}} " required="true"
                                            aria-required="true" />
