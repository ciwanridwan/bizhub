...
class CreatePertanyaanProfilePemiliksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pertanyaan_profile_pemiliks', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pertanyaan_profile_pemiliks');
    }
}
